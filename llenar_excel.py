...
def consulta(resultado):
    if resultado:
        ...
        titulos = ["#","Cod restaurante", "Lectura inicial","Lectura final","Causa mes","Paga mes","Ajus","Doc pag", "Doc aj", "Consumo activa", "Consumo reactiva", "Kw/h","Valor de Kw/h","Otros","Alumbrado"]
